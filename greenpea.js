...
function meatinfo(){
    document.getElementById("meat-info").style.display = "inline"
    document.getElementById("dshowto").style.display = "none"
}
function vegetinfo(){
    document.getElementById("veget-info").style.display = "inline"
    document.getElementById("dshowto").style.display = "none"
}
function tigerinfo(){
    document.getElementById("tiger-info").style.display = "inline"
    document.getElementById("dshowto").style.display = "none"
}
function virusinfo(){
    document.getElementById("virus-info").style.display = "inline"
    document.getElementById("dshowto").style.display = "none"
}
function howToPlay() {
    document.getElementById("dsplay").style.display = "none";
    document.getElementById("dshowto").style.display = "inline";
    document.getElementById("meat-info").style.display = "none"
    document.getElementById("veget-info").style.display = "none"
    document.getElementById("tiger-info").style.display = "none"
    document.getElementById("virus-info").style.display = "none"
}
...
function startGame() { //game load function
    document.getElementById("dsplay").style.display = "none";
    document.getElementById("dshowto").style.display = "none";
    document.getElementById("killed").style.display = "none";
    ...
    tiger[1] = new component(60, 60, "https://cdn.discordapp.com/attachments/820894723119644672/823845422165393468/Tiger_1.gif", 450, 200, "enemy");
    virus[0] = new component(50, 50, "https://cdn.discordapp.com/attachments/820894723119644672/846266479683043358/New_Virus.gif", 75, 50, "enemy");
    virus[1] = new component(50, 50, "https://cdn.discordapp.com/attachments/820894723119644672/846335242508042240/New_Virus_clone_1.gif", 0, 250, "enemy");
    for (let i = 0; i < 5; i++){
...
function component(width, height, color, x, y, type) { //create things
    this.type = type;
...
function updateGameArea(){ //makes everything living
    ...
    if (virus[0].x == 75 && virus[0].y == 50) {virus[0].speedX = 0; virus[0].speedY = 10}//first virus
    if (virus[0].x == 75 && virus[0].y == 600) {virus[0].speedX = 5; virus[0].speedY = 0}
    if (virus[0].x == 375 && virus[0].y == 600) {virus[0].speedX = 0; virus[0].speedY = -10}
